function generateQuestionnaires(data, checkedStates = {}) {
    ...
    data.forEach((questionnaire, index) => {
        ...
        if (questionnaire.title.toLowerCase() === 'demographics') {
            const questions = [
                {
                    label: "How do you currently describe your gender identity?",
                    inputId: "gender-identity"
                },
                {
                ...
                {
                    label: "In what country did you spend your formative years?",
                    inputId: "country"
                },
                {
                    label: "What is your course of study or job title?",
                    inputId: "course-or-job"
                }
            ];
        ...
        // Append questionnaire section only once (outside of the condition)
